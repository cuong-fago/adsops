...
export async function loadWorkspacePack(userId: string, clientId: string): Promise<WorkspacePack> {
  ...
  const [
    ...
    readFolder("report", clientId),
    readFolder("compare", clientId),
    readFolder("alerts", clientId),
    readFolder("guard", clientId),
    readFolder("hub", clientId),
    readFolder("proposals", clientId),
    readFolder("classify", clientId),
    readFolder("final", clientId),
    readFolder("connect", clientId),
    readJsonRelative("sop.json"),
    readFolder("analytics", clientId),
    readFolder("budget-email", clientId),
  ]);
